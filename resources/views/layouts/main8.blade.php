...
<div id="id_twitter" target="_blank" class="text-center" style="position:fixed; top:288px; right:-250px; font-size:25px; font-weight:300; height:44px; width:300px; background-color:#1da1f2; cursor:pointer;">
...
<div id="id_linkedin" target="_blank" class="text-center" style="position:fixed; top:332px; right:-250px; font-size:25px; font-weight:300; height:44px; width:300px; background-color:#0073b1; cursor:pointer;">
